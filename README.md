## control_msgs (jazzy) - 5.10.0-1

The packages in the `control_msgs` repository were released into the `jazzy` distro by running `/home/bmagyar/.local/bin/bloom-release -r jazzy control_msgs` on `Tue, 08 Sep 2026 12:15:19 -0000`
...
## control_msgs (kilted) - 6.10.0-1

The packages in the `control_msgs` repository were released into the `kilted` distro by running `/home/bmagyar/.local/bin/bloom-release control_msgs -r kilted` on `Wed, 01 Jul 2026 22:23:34 -0000`
...
## control_msgs (lyrical) - 6.10.0-1

The packages in the `control_msgs` repository were released into the `lyrical` distro by running `/home/bmagyar/.local/bin/bloom-release control_msgs -r lyrical` on `Wed, 01 Jul 2026 22:21:36 -0000`
...
## control_msgs (rolling) - 6.10.0-1

The packages in the `control_msgs` repository were released into the `rolling` distro by running `/home/bmagyar/.local/bin/bloom-release control_msgs -r rolling` on `Wed, 01 Jul 2026 22:20:00 -0000`
...
## control_msgs (rolling) - 6.9.0-1

The packages in the `control_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling control_msgs` on `Thu, 02 Apr 2026 12:41:41 -0000`
...
## control_msgs (kilted) - 6.9.0-1

The packages in the `control_msgs` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted control_msgs` on `Thu, 02 Apr 2026 12:38:44 -0000`
...
## control_msgs (jazzy) - 5.9.0-1

The packages in the `control_msgs` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy control_msgs` on `Thu, 02 Apr 2026 12:36:48 -0000`
...
## control_msgs (humble) - 4.9.0-1

The packages in the `control_msgs` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble control_msgs` on `Thu, 02 Apr 2026 12:31:44 -0000`
...
## control_msgs (jazzy) - 5.8.0-1

The packages in the `control_msgs` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy control_msgs` on `Mon, 02 Feb 2026 16:25:14 -0000`
...
## control_msgs (kilted) - 6.8.0-1

The packages in the `control_msgs` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted control_msgs` on `Mon, 02 Feb 2026 16:23:44 -0000`
...
## control_msgs (rolling) - 6.8.0-1

The packages in the `control_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling control_msgs` on `Mon, 02 Feb 2026 16:20:25 -0000`
...
## control_msgs (jazzy) - 5.7.0-1

The packages in the `control_msgs` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy control_msgs` on `Wed, 31 Dec 2025 10:51:58 -0000`
...
## control_msgs (kilted) - 6.7.0-1

The packages in the `control_msgs` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted control_msgs` on `Wed, 31 Dec 2025 10:21:19 -0000`
...
## control_msgs (rolling) - 6.7.0-1

The packages in the `control_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling control_msgs` on `Wed, 31 Dec 2025 09:39:18 -0000`
...
## control_msgs (rolling) - 6.6.0-1

The packages in the `control_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling control_msgs` on `Tue, 09 Dec 2025 18:04:46 -0000`
...
## control_msgs (kilted) - 6.5.0-1

The packages in the `control_msgs` repository were released into the `kilted` distro by running `/home/bmagyar/.local/bin/bloom-release -r kilted control_msgs` on `Wed, 27 Aug 2025 11:36:46 -0000`
...
## control_msgs (rolling) - 6.5.0-1

The packages in the `control_msgs` repository were released into the `rolling` distro by running `/home/bmagyar/.local/bin/bloom-release -r rolling control_msgs` on `Wed, 27 Aug 2025 11:28:43 -0000`
...
The packages in the `control_msgs` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble control_msgs` on `Wed, 12 Mar 2025 08:49:31 -0000`
